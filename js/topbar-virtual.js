...
document.addEventListener("DOMContentLoaded", function() {
  ...
  downloadButton.addEventListener("click", function() {
    ...
    link.href = "../assets/img/cv/janzaid_cv.pdf"; // Replace with the actual path to your PDF
    link.target = "_blank";
    link.download = "janzaid-resume.pdf"; // The suggested name for the downloaded file
